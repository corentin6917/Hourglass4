...
class SharedDataManager {
    ...
    private enum Keys {
        ...
        static let pendingGoalsList = "widget_pending_goals_list" // NEW: Liste détaillée
    }

    // MARK: - Read Data (pour le widget)
    var grainsToday: Int {
    ...
    var timeUntilDeadline: TimeInterval {
        ...
        // Créer une date pour 20h aujourd'hui
        ...
        // Si on est après 20h, retourner 0
        if now > deadline {
            return 0
        }
    ...
    // NEW: Récupérer la liste détaillée des objectifs en cours
    ...
    // MARK: - Write Data (depuis l'app principale)
    func updateWidgetData(
        ...
        // NEW: Sauvegarder la liste détaillée des objectifs
